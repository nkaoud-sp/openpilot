...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"AutoLockEnabled", {PERSISTENT, BOOL, "0"}},
    {"CloseWindows", {PERSISTENT, BOOL, "0"}},
    ...
    {"LockDoorsTimer", {PERSISTENT, INT, "2"}},
    ...
    {"ParkDistance", {PERSISTENT | BACKUP, INT, "270"}},
