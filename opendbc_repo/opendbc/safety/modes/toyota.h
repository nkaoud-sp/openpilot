...
#define TOYOTA_BASE_TX_MSGS \
  {0x191, 0, 8, .check_relay = true}, {0x412, 0, 8, .check_relay = true}, {0x1D2, 0, 8, .check_relay = false}, {0x7C0, 0, 8, .check_relay = false}, {0x614, 0, 8, .check_relay = false}, /* LKAS + LTA + PCM + Turn Signals */  \
