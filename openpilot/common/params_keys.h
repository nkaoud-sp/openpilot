...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"LanePolicyCorrection", {CLEAR_ON_ONROAD_TRANSITION, FLOAT, "0.0"}},
    {"LanePolicyLeadFallback", {PERSISTENT | BACKUP, BOOL, "0"}},
    {"LanePolicyMode", {CLEAR_ON_ONROAD_TRANSITION, INT, "0"}},
    ...
    {"OffroadCanScript", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BYTES}},
    ...
    {"ParkDistance", {PERSISTENT | BACKUP, INT, "280"}},
