...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"OffroadTurnSignalSequence", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
    ...
    {"DynamicFollowCurve", {PERSISTENT | BACKUP, INT, "100"}},
    {"DynamicFollowMaxTime", {PERSISTENT | BACKUP, INT, "110"}},
    {"DynamicFollowMinTime", {PERSISTENT | BACKUP, INT, "50"}},
    {"EnableCopyparty", {PERSISTENT | BACKUP, BOOL}},
    {"EnableGithubRunner", {PERSISTENT | BACKUP, BOOL}},
    {"ExperimentalSpeedAssistLeadMode", {PERSISTENT | BACKUP, INT, "0"}},
    {"ExperimentalSpeedAssistMaxKph", {PERSISTENT | BACKUP, INT, "130"}},
    {"ExperimentalSpeedAssistMinKph", {PERSISTENT | BACKUP, INT, "50"}},
    {"ExperimentalSpeedAssistMode", {PERSISTENT | BACKUP, INT, "0"}},
    {"ExperimentalSpeedAssistStartGapKph", {PERSISTENT | BACKUP, INT, "8"}},
    {"ExperimentalSpeedAssistStrength", {PERSISTENT | BACKUP, INT, "1"}},
    ...
    {"RememberExperimentalModeStatus", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"ToyotaReverseCruise", {PERSISTENT | BACKUP, BOOL, "0"}},
    ...
    {"LaneChangeButtonDirection", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, INT, "0"}},
    {"LaneTurnButtonDirection", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, INT, "0"}},
    {"LaneTurnButtonsVisible", {PERSISTENT | BACKUP, BOOL, "0"}},
