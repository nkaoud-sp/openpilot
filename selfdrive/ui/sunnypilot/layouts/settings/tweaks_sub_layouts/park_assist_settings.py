...
class ParkAssistSettingsLayout(Widget):
  ...
  def _initialize_items(self):
    ...
    self._park_mode = multiple_button_item_sp(
      ...
      description=lambda: tr("From Full Stop: only after you stop behind a stopped lead, then holds through the " +
                            "launch and opens as you speed up. Any Low Speed: also applies the closer gap while " +
                            "following at low speed (stop-and-go)."),
