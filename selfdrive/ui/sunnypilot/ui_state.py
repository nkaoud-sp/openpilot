...
class UIStateSP:
  ...
  def update_params(self) -> None:
    ...
    self.experimental_speed_assist_mode = self.params.get("ExperimentalSpeedAssistMode", return_default=True)
    self.experimental_speed_assist_strength = self.params.get("ExperimentalSpeedAssistStrength", return_default=True)
    ...
    self.lane_center_assist_mode = self.params.get("LaneCenterAssistMode", return_default=True)
    self.lane_center_assist_strength = self.params.get("LaneCenterAssistStrength", return_default=True)
